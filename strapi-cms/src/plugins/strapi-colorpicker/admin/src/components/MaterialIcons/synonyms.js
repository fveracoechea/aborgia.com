const synonyms = {
  ...
  ElectricMoped:
    "automobile bike cars maps scooter transportation vehicle vespa",
  ...
  FeaturedVideo:
    "advertisment highlighted item play recommended watch,advertised",
  ...
  IosShare:
    "arrows button direction internet link send sharing social up website",
